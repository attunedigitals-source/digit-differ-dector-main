  ...
  <div className="min-h-screen bg-background text-foreground">
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        ...
        <h2 className="text-xl font-bold text-foreground">2. Account Access and Automation Data</h2>
        <p>Digit Bot Pro is designed with a client-side architecture. Account access and active automation execution data are intended to remain on your device during normal use. We do not intentionally store your private automation credentials in plain form on our servers.</p>
