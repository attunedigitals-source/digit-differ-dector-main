  ...
  <div className="min-h-screen bg-background text-foreground">
    <div className="container mx-auto px-6 py-12 max-w-4xl">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        ...
        <p>You must be legally permitted to use trading-related software in your jurisdiction and be responsible for ensuring local compliance.</p>
        ...
        <p>Trading synthetic indices carries significant financial risk. You accept full responsibility for gains, losses, and decisions made using the tool.</p>
        ...
        <p>To the maximum extent permitted by law, Digit Bot Pro and its operators are not liable for indirect, incidental, special, consequential, or trading-related losses.</p>
